...
2. **เลือก IDE** ที่รองรับ MicroPython เช่น:
   - **Thonny IDE** (แนะนำสำหรับมือใหม่)
   - **uPyCraft IDE**
   - **Ampy (Adafruit MicroPython Tool)** สำหรับอัปโหลดผ่าน Command Line
3. **อัปโหลดโค้ด** ไปยัง KidBright
   - ใน **Thonny IDE** ให้เลือก **Interpreter -> MicroPython (ESP32)**
   - เชื่อมต่อบอร์ดผ่าน **USB** และกด **Run**
4. **เปิดใช้งานบอร์ด** และลองนำมือเข้าใกล้เซ็นเซอร์ (น้อยกว่า 10 ซม.)
5. **เซอร์โวจะหมุน** เพื่อกดหัวจ่ายแอลกอฮอล์อัตโนมัติ
